...
require (
	...
	github.com/docker/cli v23.0.0-rc.1+incompatible // v22.06.x - see "replace" for the actual version
	github.com/docker/cli-docs-tool v0.5.0
	github.com/docker/distribution v2.8.1+incompatible
	github.com/docker/docker v23.0.0-rc.1+incompatible // v22.06.x - see "replace" for the actual version
